...
_C.DATASET.Label = 'all'  # train on all labels, test on part labels (35 for peta, 51 for rap)
...
_C.TRAIN.DATAAUG.AUTOAUG_PROB = 0.

_C.TRAIN.EMA = CN()
_C.TRAIN.EMA.ENABLE = False
# _C.TRAIN.EMA.DECAY = 0.9998
_C.TRAIN.EMA.DECAY = 0.9997
